...
document
  ...
  .addEventListener("submit", async function (e) {
    ...
    let confirm = document.getElementById("confirmRegisterPassword").value;
    ...
    if (password.length < 4 || password.length > 16) {
      ...
      message.innerHTML = "Password must be 4-16 characters";
    ...
    try {
      ...
      if (data.success) {
        ...
        message.innerHTML = "Account created. Your ID: " + data.user_id;
...
document
  ...
  .addEventListener("submit", async function (e) {
    ...
    try {
      let response = await fetch("PHP/login/auth/login.php", {
        method: "POST",
...
async function verifyAccount() {
  ...
  try {
    let response = await fetch("PHP/login/auth/verify-account.php", {
      method: "POST",
...
async function updatePassword() {
  ...
  try {
    let response = await fetch("PHP/login/auth/reset-password.php", {
      method: "POST",
